...
class ScapegoatTree(BinarySearchTree):
    ...
    def _initialize(self):
        self.n = 0
        self.q = 0
        self.s = 0 #variável criada para armazenar tamanho das subarvores
...
#para solucionar pensei em criar uma função para
#realizar o percurso "em ordem" para pegar cada nó e armazenar seu tamanho
#neste caso percorrendo em ordem e armazendando em 'u.s' criado na inicialização
#primeiro roda o percurso e para cada nó armazena o tamanho da sua subarvore
    def tamanho(self):
    ...
    def numero_emOrdem(self, u):
        if u != None:
            ...
            u.s = self._size(u)
            print("O tamanho de do nó %d é: " %u.x, u.s) #imprime o tamanho de cada nó
            self.numero_emOrdem(u.right)

#sua implementação nao alteraria tanto pois como é uma função recursiva
#ela sera executada em ordem de O(n)